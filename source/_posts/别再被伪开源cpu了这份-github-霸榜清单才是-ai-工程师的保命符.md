...
cover: "/medias/post-open-source-cpu.webp"
img: /medias/post-open-source-cpu.webp
---
...
![上线前双手合十祈祷永无 BUG 的表情](/medias/post-open-source-cpu-emoji-1.webp)
> 先拜一拜，再点发布
...
![系统当面抛出一个异常时的无语表情](/medias/post-open-source-cpu-emoji-2.webp)
> 看到协议限制时的表情
