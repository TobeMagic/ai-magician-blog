...
img: "https://iili.io/BU8M0w7.png"
swiperImg: "https://iili.io/BU8M0w7.png"
...
cover: "https://iili.io/BU8M0w7.png"
---
...
这里的「一个」指的是 OpenAI——他最近刚从 OpenAI 拿到 offer，在 Anthropic 的账号被封期间，这个时机显得格外刺眼。

![](https://iili.io/BU8Gxqb.png)
> Anthropic：这可疑活动指的是……用竞品的 API 做集成测试？
...
账号最终解封，但整个沟通过程本身就是答案——当你的框架严重依赖某一个模型提供商的时候，定价权不在你手里。
...
安全扫描在 OpenClaw 早期发现了约 3 万个暴露在互联网上的实例，后续评估识别出 13.5 万次安装，覆盖 82 个国家，其中约 1.52 万存在远程代码执行（RCE）漏洞 [3](https://www.crowdfundinsider.com/2026/04/270927-certik-warns-of-critical-security-vulnerabilities-in-ai-agent-openclaw/)。
...
**第二**，检查部署模式——本地部署比托管模式更可控，但运维成本更高。**第三**，建立工具权限最小化原则，不管选哪个框架，「不给 Agent 超权限」是基本功。
...
![正文图解 2](https://iili.io/BU8MTnn.png)
> 正文图解 2
