...
![面试官一追问，我才发现我只背过 ReAct 这个词](https://iili.io/B9fewPa.png)
...
![工具超时了，Observation 阶段怎么接住](https://iili.io/B4X3oAB.png)
...
![参数校验是我加的，不是模型自己做的](https://iili.io/qbiS47S.png)
> 参数校验是我加的，不是模型自己做的
...
![复杂场景下，单一模式根本不够用](https://iili.io/BgVFVPp.png)
> 复杂场景下，单一模式根本不够用
...
![断点续传这个能力，差点让我在生产环境翻车](https://iili.io/B6v6407.png)
...
![切分策略调了三版，效果还是玄学](https://iili.io/qyujVJ2.png)
> 切分策略调了三版，效果还是玄学
...
![调 Prompt 调了三个月，才发现没有基线对比](https://iili.io/BLtq0fn.png)
...
![行吧，这个坑我先记下](https://iili.io/qbi8SHP.png)
> 行吧，这个坑我先记下
...
![背压问题差点让我在凌晨两点跑路](https://iili.io/B6pAG0F.png)
> 背压问题差点让我在凌晨两点跑路
...
<div class="academic-reference-list"> <p class="reference-item">[1] 原始资料[EB/OL]. https://github.com/guocong-bincai/ai-interview-guide. (2026-05-03).</p> </div>
